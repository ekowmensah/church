...
// Permission check for viewing pending members
if (!has_permission('view_pending_members')) {
...
$can_edit = has_permission('edit_member');
$can_delete = has_permission('delete_member');
$can_activate = has_permission('activate_member');
$can_complete_registration = has_permission('complete_member_registration');
