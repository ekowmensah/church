...
if (!$is_super_admin && !has_permission('view_profession_report')) {
...
$can_export = $is_super_admin || has_permission('export_profession_report');
...
<div class="container mt-4">
    ...
    <h2 class="mb-4 font-weight-bold"><i class="fas fa-user-md mr-2"></i>Profession Report</h2>
    <form method="get" class="form-inline mb-3">
        <div class="form-group mr-2">
            <label for="profession" class="mr-2 font-weight-bold">Filter by Profession:</label>
            <select name="profession" id="profession" class="form-control">
                <option value="">All</option>
                <?php foreach ($professions as $prof): ?>
                    <option value="<?php echo htmlspecialchars($prof); ?>"<?php if ($selected_profession === $prof) echo ' selected'; ?>><?php echo htmlspecialchars($prof); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
