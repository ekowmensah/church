...
if (!$is_super_admin && !has_permission('view_payment_made_report')) {
...
$can_export = $is_super_admin || has_permission('export_payment_made_report');
...
<div class="container mt-4">
    ...
    <h2 class="mb-4 font-weight-bold"><i class="fas fa-money-check-alt mr-2"></i>Payment Made Report</h2>
