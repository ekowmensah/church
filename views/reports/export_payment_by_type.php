...
// Generate filename
$filename = 'payment_by_type_' . date('Y-m-d_H-i-s') . '.csv';
...
// CSV Headers
fputcsv($output, ['Payment Type', 'Number of Payments', 'Total Amount (₵)', 'Average Amount (₵)', 'Min Amount (₵)', 'Max Amount (₵)', 'Percentage of Total']);
