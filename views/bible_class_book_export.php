...
body{font-family:Arial,sans-serif;color:#182b3a;margin:24px}.report-title{text-align:right;font-style:italic;color:#173f5f}.meta{margin:8px 0 16px;color:#526575}table{border-collapse:collapse;width:100%;font-size:11px}th,td{border:1px solid #8da2b3;padding:5px;white-space:nowrap}th{background:#173f5f;color:#fff}.member-col{background:#eaf2f8}.attendance{background:#eef7ff;text-align:center}.payment{background:#eef9ef;text-align:right}.footer{text-align:center;margin-top:18px;font-size:10px;color:#40576a}@media print{body{margin:10mm}.no-print{display:none}.footer{position:fixed;bottom:0;left:0;right:0}}
</style></head><body>
<div class="report-title"><?= htmlspecialchars($title) ?></div>
<h2><?= htmlspecialchars($class['church_name']) ?></h2><div class="meta">Reporting period: <?= htmlspecialchars($bookData['start_date']) ?> to <?= htmlspecialchars($bookData['end_date']) ?></div>
...
<div class="footer">Powered By: MyFreeman Digital NetWorks - Evangelism, Through Digitalization!<br>FDN: Extenditque Manum Omni Membri, Ubique!!</div>
