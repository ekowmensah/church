<?php
// activity_logs.php - Professional Activity Log Viewer
ob_start();
        ...
        <div class="col-12 col-lg-10 mx-auto">
            <div class="card shadow-sm">
                <div class="card-header bg-light d-flex align-items-center justify-content-between">
                    <div><i class="fas fa-user-shield text-primary mr-2"></i>Activity Logs</div>
                    <a href="export_activity_logs.php?<?=http_build_query($_GET)?>" class="btn btn-outline-success btn-sm"><i class="fas fa-file-csv mr-1"></i>Export CSV</a>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="activityLogsTable" class="table table-bordered table-striped table-sm">
