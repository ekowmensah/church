                ...
                <table id="menuTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($item['permission_name'] ?? '') ?></td>
                            ...
                            <td>
                                <button class="btn btn-sm btn-warning edit-btn" 
                                        ...
                                        data-permission="<?= htmlspecialchars($item['permission_name'] ?? '') ?>"
...
// Define modals outside the output buffer
// First, build permissions options
$permissions_options = '';
$permissions->data_seek(0);
while ($perm = $permissions->fetch_assoc()) {
    $permissions_options .= '<option value="' . htmlspecialchars($perm['name']) . '">' . htmlspecialchars($perm['name']) . '</option>';
}
        ...
        <div class="modal-content">
            ...
            <form id="editMenuForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Permission Required</label>
                        <select class="form-control" name="permission_name" id="edit_permission">
                            <option value="">No permission required</option>
                            {$permissions_options}
                        </select>
                    </div>
...
$(document).ready(function() {
    ...
    // Edit button click (using event delegation for dynamically generated buttons)
    ...
    // Delete button click (using event delegation for dynamically generated buttons)
